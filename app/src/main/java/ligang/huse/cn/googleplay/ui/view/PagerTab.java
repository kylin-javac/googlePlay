...
import ligang.huse.cn.googleplay.ui.activity.BaseActivity;
...
public class PagerTab extends ViewGroup {
    ...
    private void init() {
        //把一个值从dip转换成px
        mIndicatorHeight = UiUitls.dipTopx(mIndicatorHeight);
        mDividerPadding = UiUitls.dipTopx(mDividerPadding);
        mTabPadding = UiUitls.dipTopx(mTabPadding);
        mDividerWidth = UiUitls.dipTopx(mDividerWidth);
        mTabTextSize = UiUitls.dipTopx(mTabTextSize);
        //创建一个scroller
    ...
    private void addTextTab(final int position, String title) {
        ...
        tab.setTextColor(UiUitls.getColorStateList(mTabTextColorResId));
        tab.setBackgroundDrawable(UiUitls.getDrawable(mTabBackgroundResId));
